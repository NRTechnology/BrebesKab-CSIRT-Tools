...
def print_help() -> None:
    ...
    print(
        ...
        "\n"
        "Usage:\n"
        "  python scripts/recon/target.py init\n"
        "  python scripts/recon/target.py add\n"
        "  python scripts/recon/target.py list\n"
        "  python scripts/recon/target.py show\n"
        "  python scripts/recon/target.py verify\n"
        "  python scripts/recon/target.py status\n"
        "  python scripts/recon/target.py remove\n"
        "  python scripts/recon/target.py version\n"
        "\n"
